...
export default function AdminProductList() {
  ...
  //handlerFilter function for filtering category and brands
  ...
  //handle sort sort the prices and rating
  ...
  //reset to page1 after filtering
  useEffect(() => {
    setPage(1);
  }, [totalItems, sort]);

  //api for filter and categories
  useEffect(() => {
